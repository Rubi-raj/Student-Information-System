...
public class StudentHomeworkFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_student_homework, container, false);
        listView = (ListView) root.findViewById(R.id.listhomework);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                DatabaseReference databaseReference = firebaseDatabase.getReference().child("Message").child("Student").child("HomeWork").child(regno);
        ...
        databaseReference = firebaseDatabase.getReference().child("Message").child("Student").child("HomeWork").child("ALL");
        databaseReference.addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                String value1 = dataSnapshot.getValue(StaffMessage.class).display();
